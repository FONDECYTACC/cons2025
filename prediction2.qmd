...
```{r }
 split2125<- 
nanoparquet::read_parquet("_out/death_split_seed2125_test20.parquet")
```
...
predictors <- c(
  ...
  "cohabitation", "sub_dep_icd10_status", "any_violence", "prim_sub_freq_rec", 
  "tr_outcome", "adm_motive", "first_sub_used", "primary_sub_mod", 
  "tipo_de_vivienda_rec2", "national_foreign", 
