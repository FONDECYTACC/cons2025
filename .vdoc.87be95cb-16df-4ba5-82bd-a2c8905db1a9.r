...
py_corrected_datasets_nondum <- purrr::map(
...
glimpse(py_corrected_datasets_nondum[[1]])
#
#
#
#
...
predictors <- c(
  ...
  "adm_age_rec3", "porc_pobr", "dit_m", "tenure_status_household", 
  "prim_sub_freq_rec", "national_foreign", "urbanicity_cat", 
